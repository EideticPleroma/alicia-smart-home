...
class TTSService(BusServiceWrapper):
    ...
    def __init__(self):
        ...
        self._synthesis_queue_task = None
...
async def main():
    ...
    # Start the synthesis processing task
    tts_service._synthesis_queue_task = asyncio.create_task(tts_service._process_synthesis_queue())

    # Start API server
    try:
        import uvicorn
        config = uvicorn.Config(tts_service.api.app, host="0.0.0.0", port=8006)
